package com.doubleclick.datepicker;
...
import com.doubleclick.materialdatetimepicker.date.DatePickerDialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        weekendDateButton.setOnClickListener(v -> {
            ...
            for (int i = 0; i < MAX_SELECTABLE_DATE_IN_FUTURE; i++) {
                Log.e("Calendar", "onCreateView: " + list.contains(day.get(Calendar.DAY_OF_MONTH)));
                if (list.contains(day.get(Calendar.DAY_OF_MONTH))) {
